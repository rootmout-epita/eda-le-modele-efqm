...
En Europe, le chômage reste élevé jusqu’à 1985, avec jusqu’à 2,4 millions de demandeurs d’emplois en France en 1985. L’évolution du \acrshort{pib} ne dépasse pas les 2\% pendant plusieurs années (1980 : 1,6\%, 1981 : 1,1\%, 1983 : 1,3\% 1984 : 1,5 \%) et l’inflation dépasse les 13\% par année (1980, 1981).
...
\begin{figure}[!h]
    ...
    \caption{Signature de la lettre d’intention de la création de l’EFQM, 15 sept. 1988}
...
Ainsi, en octobre 1989, l’EFQM est créée. C’est alors une fondation européenne, supportée par l’Union Européenne. Lors de sa création, 67 PDG y adhèrent au modèle proposé. Une équipe d’experts du domaine académique et industriel est alors composée pour évaluer ces entreprises, ce qui amènera à la première remise du Prix de la Qualité Européenne en 1992.
...
\begin{figure}
    ...
    \caption{Première version du modèle EFQM\cite{ancien-modele-efqm}}
    \label{fig:ancien-modele}
\end{figure}

Le premier modèle EFQM \myfigurereference{fig:ancien-modele} se compose de deux grands aspects : les facteurs, qui impactent les résultats.
...
À travers toutes les versions, l’EFQM garde comme important :

\begin{itemize}[label=\textbullet, itemsep=0.1cm]
    \item la primauté du client ;
    \item le besoin d’une vision à long-terme, centrée sur les parties prenantes ;
